...
export function CTA() {
  return (
    <section id="contato" className="relative overflow-hidden bg-[var(--brand-blue-soft)] py-16 sm:py-20">
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col items-start justify-between gap-6 px-5 sm:px-6 md:flex-row md:items-center lg:px-8">
        <div className="space-y-2">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--brand-blue)]">Atendimento domiciliar rápido e sem complicação</p>
          <h2 className="text-3xl font-bold tracking-tight text-[var(--ink-900)] sm:text-4xl">Agende a visita veterinária na sua casa</h2>
          <p className="text-[var(--ink-600)]">Fale com a equipe em poucos segundos e organize o melhor horário para seu pet.</p>
        </div>
        ...
        <TrackedExternalLink
          ...
          eventParams={{ placement: "cta_section" }}
