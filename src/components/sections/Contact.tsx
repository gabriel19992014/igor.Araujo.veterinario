...
import { clinicInfo, whatsappUrl } from "@/lib/site";

export function Contact() {
  return (
    <section id="contato-detalhes" className="bg-[var(--surface-2)] py-14 sm:py-16">
      <div className="mx-auto w-full max-w-6xl px-5 sm:px-6 lg:px-8">
        <div className="space-y-6">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--brand-blue)]">Contato</p>
            <h2 className="mt-3 text-3xl font-bold tracking-tight text-[var(--ink-900)]">Agende o atendimento domiciliar do seu pet</h2>
          </div>
          ...
          <div className="space-y-3 text-[var(--ink-700)]">
            ...
            <p className="flex items-center gap-2">
              <Clock3 className="h-4 w-4 text-[var(--brand-green)]" /> Horários flexíveis para visitas domiciliares e suporte em situações urgentes
            </p>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <TrackedExternalLink
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Falar sobre atendimento domiciliar pelo WhatsApp"
              title="Falar sobre atendimento domiciliar pelo WhatsApp"
            ...
            <TrackedExternalLink
              ...
              aria-label="Ligar agora para atendimento domiciliar"
              title="Ligar agora para atendimento domiciliar"
